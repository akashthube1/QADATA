...
public class FacebookNewAccountCreation {
	...
	public static void main(String[] args) {
        ...
        dr.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Raj");
        dr.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Pardeshi");
        dr.findElement(By.xpath("//input[@aria-label='Mobile number or email address']")).sendKeys("rajpardeshi555@gmail.com");
        dr.findElement(By.xpath("//input[@aria-label='Re-enter email address']")).sendKeys("rajpardeshi555@gmail.com");
        dr.findElement(By.xpath("//input[@id='password_step_input']")).sendKeys("Rajpardeshi@3456");
        
        dr.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        Select sl = new Select(dr.findElement(By.id("day")));
        sl.selectByIndex(9);
        Select sl1 = new Select(dr.findElement(By.id("month")));
        sl1.selectByValue("10");
        Select sl2 = new Select(dr.findElement(By.id("year")));
        sl2.selectByVisibleText("1998");
